  ...
  <body>
    <div class="container-fluid content">
        ...
        <div class="row flex-center">
            <a href="{{ route('datos_nuevo') }}" title="Insertar nuevo">Insertar nuevo</a>
        </div>
        <div class="row">
                ...
                <tbody>
                    ...
                    <div class="modal-dialog" role="document">
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="{{ route('datos_borrar', ['id' => $valor->id]) }}" class="btn btn-danger" role="button" title="Confirmar borrado">Confirmar</a>
                        </div>
                        </div>
                    </div>
                    </div>
                    ...
                    <tr>
                        ...
                        <td><a href="{{ url('/'.$valores_tipo.'s/detalle/'.$valor->id) }}" title="Ir al detalle" class="negrita{{ $valor->activo == 0 ? ' usuario_activo_no' : ' usuario_activo_si' }}">{{ $valor->nombre }}</a></td>
                        ...
                        @endphp
                        <td><form action="{{ route('datos_editar_campo', ['id' => $valor->id, 'campo' => 'activo', 'valor' => $valor_activo_nuevo]) }}" method="get"><input type="checkbox"{{ $valor->activo == 1 ? ' checked' : '' }} onchange="this.form.submit();" title="{{ $valor_activo_tit }}"></form></td>
                        <td><a href="{{ route('datos_detalle', ['id' => $valor->id]) }}" class="text-primary" title="Editar este registro"><i class="fas fa-pencil-alt"></i></a> <a href="#" class="text-danger" title="Borrar este registro" data-toggle="modal" data-target="#confirmModal_{{ $valor->id }}"><i class="fas fa-trash-alt"></i></a></td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
        ...
        @else
            <div class="container flex-center">
                    <form action="{{ route('datos_editar') }}" method="post" role="form">
                    @csrf
                    <div class="row">
            ...
            <div class="volver_listado col-xs|sm|md|lg|xl-12" style="clear: both; display: block;"><a href="{{ route('datos_lista') }}" title="Volver al listado">Volver al listado</a></div>
        @endif
        </div>
        <div class="links">
